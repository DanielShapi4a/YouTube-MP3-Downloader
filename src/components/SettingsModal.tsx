      ...
      <div className="w-full max-w-2xl bg-surface-dim border border-outline-variant/40 rounded-xl shadow-[0_8px_32px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden animate-[fadeIn_0.2s_ease-out]">
        ...
        <div className="flex items-center justify-between p-6 border-b border-surface-container-high bg-surface">
          <div className="flex items-center gap-3">
            <span
              className="material-icons-span text-primary text-2xl"
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <div className="relative">
                ...
                <span className="material-icons-span absolute right-4 top-1/2 -translate-y-1/2 text-on-surface-variant pointer-events-none">
                  expand_more
                </span>
              </div>
            </div>
              ...
              >
                ...
                {settings.quality === Quality.KBPS_128 && (
                  <div className="absolute top-3 right-3 text-primary">
                    <span
                      className="material-icons-span text-[18px]"
                      style={{ fontVariationSettings: "'FILL' 1" }}
                    >
                      check_circle
                    </span>
          ...
          <section className="space-y-4 pt-4 border-t border-surface-container-high">
            ...
            >
              ...
              <div className="relative inline-flex items-center shrink-0">
                <div
                  className={`w-11 h-6 rounded-full transition-colors relative ${settings.advancedLogging ? 'bg-primary-container' : 'bg-surface-container-highest'}`}
                >
                  <div
                    className={`absolute top-[2px] left-[2px] w-5 h-5 rounded-full bg-tertiary transition-transform ${settings.advancedLogging ? 'translate-x-5 !bg-on-primary-container' : ''}`}
                  />
                </div>
              </div>
            </div>
