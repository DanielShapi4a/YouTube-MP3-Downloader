...
app.post('/api/metadata', async (req: express.Request, res: express.Response) => {
                ...
                tracks: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      duration: {
                        type: Type.INTEGER,
                        description: 'Duration in seconds (between 120 and 420)',
                      },
                    },
  ...
  if (isPlaylist) {
    ...
    if (
      lowercaseUrl.includes('synth') ||
      lowercaseUrl.includes('retro') ||
      lowercaseUrl.includes('car')
    ) {
    ...
    if (lowercaseUrl.includes('m83') || lowercaseUrl.includes('midnight')) {
      ...
      lowercaseUrl.includes('weeknd') ||
      lowercaseUrl.includes('blinding') ||
      lowercaseUrl.includes('light')
    ) {
      ...
      const cleanKeyword =
        url.split('v=')[1]?.split('&')[0] || url.split('/').pop() || 'Unknown Song';
